...
public class OnGoingWorkerResponce {
    ...
    public static class DataBean {
         ...
         * distance_in_km : 0.0
         * job_confirmed : 3
         * currentTime : 2018-10-22 06:13:35
         * record_count : 9
         */
        ...
        public String getJob_offer_rate() {
            return job_offer_rate;
        }

        public void setJob_offer_rate(String job_offer_rate) {
            this.job_offer_rate = job_offer_rate;
        }
