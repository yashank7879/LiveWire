...
public class CompleteJobOnGoingDetailWorkerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = CompleteJobOnGoingDetailWorkerActivity.class.getName();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
       ...
       /* Log.e("WIDTH",""+binding.rlProfileDetails.getWidth());
        Log.e("HEIGHT",""+binding.rlProfileDetails.getHeight());*/
        /*RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(binding.rlProfileDetails.getWidth(), binding.rlProfileDetails.getHeight());
        binding.svMoreInfo.setLayoutParams(layoutParams);*/
    }
