...
import com.livewire.databinding.FragmentNotificationWorkerBaseBinding;
...
public class NotificationworkerBaseFragment extends Fragment {
    ...
    public NotificationworkerBaseFragment() {
        // Required empty public constructor
    }

    public static NotificationworkerBaseFragment newInstance(String param1, String param2) {
        NotificationworkerBaseFragment fragment = new NotificationworkerBaseFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(new NotificationWorkerFragment());
