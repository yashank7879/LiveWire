...
public class ConfirmJobWorkerFragment extends Fragment implements View.OnClickListener, AdapterView.OnItemSelectedListener, SubCategoryAdapter.SubCategoryLisner {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        offeredAdapter = new ConfirmJobWorkerAdapter(mContext, offerList, mainLayout);
